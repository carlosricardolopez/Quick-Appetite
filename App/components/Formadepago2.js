    ...
    render() {
        return (
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                ...
                <Text>Nombre</Text>
                <TextInput style={{ width: '90%', borderColor: 'black', borderWidth: 1, marginBottom: 5 }} onChangeText={(event) => this.setState({ amount: event })} placeholder="Nombre"></TextInput>

                <Text>Email</Text>
                <TextInput style={{ width: '90%', borderColor: 'black', borderWidth: 1, marginBottom: 5 }} onChangeText={(event) => this.setState({ name: event })} placeholder="Email"></TextInput>

                <Text>Monto</Text>
                <TextInput style={{ width: '90%', borderColor: 'black', borderWidth: 1, marginBottom: 5 }} onChangeText={(event) => this.setState({ email: event })} placeholder="Monto"></TextInput>
